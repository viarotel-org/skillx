...
Progressive disclosure reference for common UI terminology and adjective palettes. Use when enhancing vague prompts (see SKILL.md "Enhance vague prompt" path).
