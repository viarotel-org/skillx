...
- 注册（软链，推荐）：
  ...
  ```
- 或直接把本仓库文件夹复制到 `~/.claude/skills/` 下，并重命名为 `tencentmap-jsapi-gl-skill`。
...
- 注册（软链，推荐）：
  ...
  ```
- 或直接把本仓库文件夹复制到 `~/.cursor/skills/` 下，并重命名为 `tencentmap-jsapi-gl-skill`。
...
- 注册（软链，推荐）：
  ...
  ```
- 或直接把本仓库文件夹复制到 `~/.codebuddy/skills/` 下，并重命名为 `tencentmap-jsapi-gl-skill`。
