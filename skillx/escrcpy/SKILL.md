...
- Styling uses existing UnoCSS utilities, `@viarotel-org/unocss-preset-shades`, UnoCSS icons, Element Plus, and project-local PostCSS. Do not introduce new CSS-in-JS, Tailwind configs, or UI component libraries.
